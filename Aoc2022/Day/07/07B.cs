...
namespace Aoc2022.Day._07
{
    public class _07B
    {
        ...
        public static void Do()
        {
            ...
            var freeDiskSpace = totalDiskSpace - BaseDirectory.Size;
            var requiredDiskSpace = 30000000;
            var lackOfSpace = freeDiskSpace - requiredDiskSpace;
            var sizeOfDirToDelete = AllDirs.Where(x => x.Size >= -lackOfSpace).OrderBy(x => x.Size).ToList().FirstOrDefault().Size;

            Console.WriteLine($"{nameof(_07)} B:{sizeOfDirToDelete}");
        }
    }
}
